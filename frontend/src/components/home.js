    ...
    return (
        <div className="w-screen h-screen bg-gray-700 flex flex-col justify-items-center items-center">
            ...
            <div className="m-10 w-2/4 h-1/4 flex flex-row justify-items-center items-center">
                <div
                    className="basis-1/4 h-full rounded text-white text-8xl bg-gray-500 hover:bg-gray-600 cursor-pointer"
                    onClick={() => navigate('/detect')}
                >Detect
                </div>
                <div
                    className="m-3 basis-1/2 h-full rounded text-white text-8xl bg-gray-500 hover:bg-gray-600 cursor-pointer"
